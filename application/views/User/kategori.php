...
<main class="container mt-4 mb-4 ">
  <h1 class="text-center">Resep Masakan</h1>
  <p class="text-center">Inilah tempat untuk mencari cita rasa tradisional, Beragam masakan nusantara ada disini!</p>
    ...
    <div class="row g-3 mt-4">
        <?php if (!empty($resep)): ?>
                ...
                <div class="col-md-4">
                    <a href="<?= base_url('dashboard/halaman_resep/' . $r['id_resep']); ?>" class="text-decoration-none text-dark">
                        <div class="card text-center mb-4">
                            <img src="<?= base_url('assets/recipe/foto/' . $r['foto']); ?>" class="card-img-top" style="height: 200px; object-fit: cover;">
                            <div class="card-body">
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p class="text-center">Tidak ada resep dalam kategori ini!</p>
        <?php endif; ?>
    </div>
